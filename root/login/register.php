       ...
       <div class="form-box">
         ...
         <form  id="register" method="post" action="" class="input-group" name="form" >
             <div class="column" id="left">
                ...
                <input type="email" class="input-field" placeholder="Email"   name="email" autofocus>
                <?php  
                ...
                <input type="Password" name="pwConfirm" class="input-field"    placeholder="Confirm Password" >
                <?php  
             ...
             <div class="column">
                <input type="text" class="input-field" placeholder="Firstname"  name="firstname"  autofocus>
                  <?php  
                   if(isset($error_msg['firstname'])){
                      echo "<div class='error' >".$error_msg['firstname']."</div>";
                   }
                  ?>
                <input type="text" class="input-field" placeholder="Lastname"   name="lastname" autofocus>
                <?php  
                ...
                <input type="text" name="phonenumber" class="input-field"   placeholder="Phonenumber" name="phonenumber" >
                <?php  
